...
export async function createDeal(args) {
  ...
  const fields = {
    ...
    // contato direto no próprio deal (multifield) — funciona em qualquer portal
...
/**
 * Cria uma atividade/compromisso vinculada ao negócio (crm.activity.add).
 * Usado para o agendamento (item 4). Bitrix usa TYPE_ID=1 (meeting) e datas ISO.
 * @param {object} args
